...
import 'package:oiu_student_desktop/Auth/loading.dart';
import 'package:oiu_student_desktop/Auth/register.dart';
import 'package:oiu_student_desktop/animation/animate.dart';
import 'package:oiu_student_desktop/aboutus/programmer_about.dart';
    ...
    if (formdata!.validate()) {
      ...
      if (studentlogindb!.isEmpty) {
        ...
        sharedPreferences!.setString(
          "username",
          studentlogindb![0]['username'],
        );
        sharedPreferences!.setInt("userid", studentlogindb![0]['id']);
        Navigator.of(
          context,
        ).pushReplacement(ScaleAnimate(page: LoadingPage(user: username)));
        formdata.reset();
      }
    }
  }
    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
            onPressed: () {
              Navigator.of(context).push(ScaleAnimate(page: const AboutUs()));
            },
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.of(
                          context,
                        ).pushReplacement(ScaleAnimate(page: const Register()));
                      },
                      child: const Text(
